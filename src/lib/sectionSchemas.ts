...
export const PAGE_SCHEMAS: PageSchema[] = [
...

  {
    ...
    sections: [
      ...
      { key: 'sba_updates', label: 'SBA Updates',
        description: 'Appearance only — content is managed in the SBA Updates collection.',
        fields: [], defaults: {} },
      { key: 'key_resources', label: 'Key Resources',
        ...
        defaults: { eyebrow: 'Featured', headline: 'Key Resources',
          subheadline: 'Reports, news, workshops and recordings from across our community.' },
      },
      { key: 'community_resources', label: 'Community Resources',
        fields: [
          { key: 'eyebrow', label: 'Eyebrow', type: 'text' },
          { key: 'headline', label: 'Headline', type: 'text' },
        ],
        defaults: { eyebrow: 'Community', headline: 'Connect With Us' },
      },
    ],
  },
