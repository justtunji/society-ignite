...
- Wired components: HeroSection (home hero remains in Site Settings), AboutSection, CommunitiesSection, NewsletterSection (home); About hero/why_sba/mvv/team_intro/partners_cta; Contact hero/info; JoinUs hero/why_join/levels_intro/apply_intro; Programs hero; Resources hero.
- Gallery hero schema exists but isn't wired to the page yet — admin edits won't render until consumer is updated.
