...
CREATE POLICY "Communities viewable by everyone" ON public.communities AS PERMISSIVE FOR SELECT USING (true);
...
CREATE POLICY "Stories viewable by everyone" ON public.stories AS PERMISSIVE FOR SELECT USING (true);
...
CREATE POLICY "Events viewable by everyone" ON public.events AS PERMISSIVE FOR SELECT USING (true);
...
CREATE POLICY "Gallery items viewable by everyone" ON public.gallery_items AS PERMISSIVE FOR SELECT USING (true);
...
CREATE POLICY "Partners viewable by everyone" ON public.partners AS PERMISSIVE FOR SELECT USING (true);
...
CREATE POLICY "Programs viewable by everyone" ON public.programs AS PERMISSIVE FOR SELECT USING (true);
...
CREATE POLICY "Promotions viewable by everyone" ON public.promotions AS PERMISSIVE FOR SELECT USING (true);
...
CREATE POLICY "Resources viewable by everyone" ON public.resources AS PERMISSIVE FOR SELECT USING (true);
...
CREATE POLICY "Navigation items viewable by everyone" ON public.navigation_items AS PERMISSIVE FOR SELECT USING (true);
...
CREATE POLICY "Pages viewable by everyone" ON public.pages AS PERMISSIVE FOR SELECT USING (true);
...
CREATE POLICY "Sections viewable by everyone" ON public.sections AS PERMISSIVE FOR SELECT USING (true);
...
CREATE POLICY "Site settings viewable by everyone" ON public.site_settings AS PERMISSIVE FOR SELECT USING (true);
...
CREATE POLICY "Public team members viewable by everyone" ON public.team_members_public AS PERMISSIVE FOR SELECT USING (true);
...
CREATE POLICY "Anyone can insert contact submissions" ON public.contact_submissions AS PERMISSIVE FOR INSERT WITH CHECK (true);
