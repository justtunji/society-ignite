...
-- Fix ALL RLS policies to be PERMISSIVE for proper admin access

-- communities
DROP POLICY IF EXISTS "Communities are editable by admins" ON public.communities;
DROP POLICY IF EXISTS "Communities are viewable by everyone" ON public.communities;
CREATE POLICY "Communities are viewable by everyone" ON public.communities FOR SELECT USING (true);
CREATE POLICY "Communities are editable by admins" ON public.communities FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin')) WITH CHECK (has_role(auth.uid(), 'admin'));

-- contact_submissions
DROP POLICY IF EXISTS "Anyone can create contact submissions" ON public.contact_submissions;
DROP POLICY IF EXISTS "Contact submissions are deletable by admins" ON public.contact_submissions;
DROP POLICY IF EXISTS "Contact submissions are updatable by admins" ON public.contact_submissions;
...
CREATE POLICY "Contact submissions manageable by admins" ON public.contact_submissions FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin')) WITH CHECK (has_role(auth.uid(), 'admin'));

-- events
DROP POLICY IF EXISTS "Events are editable by admins" ON public.events;
DROP POLICY IF EXISTS "Events are viewable by everyone" ON public.events;
CREATE POLICY "Events are viewable by everyone" ON public.events FOR SELECT USING (true);
CREATE POLICY "Events are editable by admins" ON public.events FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin')) WITH CHECK (has_role(auth.uid(), 'admin'));
...
CREATE POLICY "Gallery items are editable by admins" ON public.gallery_items FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin')) WITH CHECK (has_role(auth.uid(), 'admin'));
...
CREATE POLICY "Admins can manage all members" ON public.members FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin')) WITH CHECK (has_role(auth.uid(), 'admin'));
CREATE POLICY "Members can view their own profile" ON public.members FOR SELECT TO authenticated USING (auth.uid() = user_id);
CREATE POLICY "Members can update their own profile" ON public.members FOR UPDATE TO authenticated USING (auth.uid() = user_id);
CREATE POLICY "Users can create their own member profile" ON public.members FOR INSERT TO authenticated WITH CHECK (auth.uid() = user_id);
...
CREATE POLICY "Navigation items are editable by admins" ON public.navigation_items FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin')) WITH CHECK (has_role(auth.uid(), 'admin'));
...
CREATE POLICY "Pages are editable by admins" ON public.pages FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin')) WITH CHECK (has_role(auth.uid(), 'admin'));
...
CREATE POLICY "Partners are editable by admins" ON public.partners FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin')) WITH CHECK (has_role(auth.uid(), 'admin'));
...
CREATE POLICY "Programs are editable by admins" ON public.programs FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin')) WITH CHECK (has_role(auth.uid(), 'admin'));
...
CREATE POLICY "Promotions are editable by admins" ON public.promotions FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin')) WITH CHECK (has_role(auth.uid(), 'admin'));
...
CREATE POLICY "Resources are editable by admins" ON public.resources FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin')) WITH CHECK (has_role(auth.uid(), 'admin'));
...
CREATE POLICY "Sections are editable by admins" ON public.sections FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin')) WITH CHECK (has_role(auth.uid(), 'admin'));
...
CREATE POLICY "Site settings are manageable by admins" ON public.site_settings FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin')) WITH CHECK (has_role(auth.uid(), 'admin'));

-- stories
DROP POLICY IF EXISTS "Stories are editable by admins" ON public.stories;
DROP POLICY IF EXISTS "Stories are viewable by everyone" ON public.stories;
CREATE POLICY "Stories are viewable by everyone" ON public.stories FOR SELECT USING (true);
CREATE POLICY "Stories are editable by admins" ON public.stories FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin')) WITH CHECK (has_role(auth.uid(), 'admin'));

-- team_members
DROP POLICY IF EXISTS "Team members are editable by admins" ON public.team_members;
DROP POLICY IF EXISTS "Team members are viewable by admins" ON public.team_members;
CREATE POLICY "Team members are manageable by admins" ON public.team_members FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin')) WITH CHECK (has_role(auth.uid(), 'admin'));
...
CREATE POLICY "Public team members are editable by admins" ON public.team_members_public FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin')) WITH CHECK (has_role(auth.uid(), 'admin'));
